...
* Armed with the knowledge from the discussion the students will write a one page article about **___** (insert school, topic, something that is obtainable the students need to be able to interview someone about it) Ex. student wants to write about gaming interview someone that is affiliated or plays games ask real questions such as, does video gaming affect your sleep? Could you be doing something more useful with your time? Use the good story guideline (from students notes) and the black box guide (attached) to guide the questioning and story development process.
