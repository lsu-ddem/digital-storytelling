...
The students will begin to manipulate and create using [audacity](http://www.audacityteam.org/). [Software documentation](https://support.audacityteam.org/) as well as self documentation will be encouraged when exploring and troubleshooting.
...
* [Audacity software download](https://www.audacityteam.org/download/)  that students will use to produce and manipulate their sounds.
* [Audacity software documentation](https://support.audacityteam.org/) that students and instructors should become familiar with and learn how to navigate.
* [Free sound resource](https://freesound.org/) that students may use to find a sound to experiment with in Audacity. Note that there are other resources online.
